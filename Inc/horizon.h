...
static inline void drawHorizon(int32_t rolDegrees, int32_t pitchDegrees) {
	...
	if(rolDegrees < 0) {
		...
		startIndex = (degrees-1)*4;
	} else {
		xArr = positiveCornerX;
		yArr = positiveCornerY;
		startIndex = degrees*4;
	}
